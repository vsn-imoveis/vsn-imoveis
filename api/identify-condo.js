export default async function handler(req,res){
  ...
  try{
    ...
    add(/elevador/,'Elevador');add(/churrasqueira/,'Churrasqueira');add(/academia/,'Academia');add(/salao de festas/,'Salão de festas');add(/playground/,'Playground');add(/portaria.{0,25}24|24.{0,25}portaria|seguranca 24/,'Portaria 24h');add(/piscina/,'Piscina');add(/quadra esportiva|quadra de esportes/,'Quadra esportiva');add(/brinquedoteca/,'Brinquedoteca');add(/salao de jogos/,'Salão de jogos');add(/espaco gourmet/,'Espaço gourmet');add(/area verde/,'Área verde');add(/bicicletario/,'Bicicletário');add(/piscina infantil/,'Piscina infantil');add(/solarium/,'Solarium');add(/jardim/,'Jardim');add(/coworking/,'Coworking');add(/pet place/,'Pet place');add(/sauna/,'Sauna');
